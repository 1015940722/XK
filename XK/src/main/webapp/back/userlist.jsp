						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered table-striped">
									...
									<tr>
										<td><center>${us.uId}</center></td>
										<td><center>${us.uUsername}</center></td>
										<td><center>${us.uName}</center></td>
										<td><center>******</center></td>
										<td><center><fmt:formatDate value="${us.uDate}" pattern="yyyy年MM月dd日 "/></center></td>
