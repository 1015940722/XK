        	...
        	<div class="span3">
                ...
                <nav  class="work-nav">
                    <ul id="filters" class="option-set" data-option-key="filter">
                        ...
                        <a href="findt.htm?lei=${type.tName }#xiazai"><li><a href="findt.htm?lei=${type.tName }#xiazai" data-option-value=".code" onclick="gototo(3);">${type.tName }</a></li></a>
                   		</c:forEach>
                    </ul>
    ...
    <div class="row">
    	<div class="span9">
         ...
         <script>
        	...
        	<form action="additPost.htm" name="formq" method="get" id="contact-form" class="contact-form" ">
               
                <p class="contact-message">
                	<textarea id="contact_message" placeholder="你想说的话" name="content" rows="15" cols="40"></textarea>
                </p>
                <p class="contact-submit">
                	<button id="but" class="submit" type="submit" style="border-color: #696969" onclick="aaaw()">submit</button>
                </p>
