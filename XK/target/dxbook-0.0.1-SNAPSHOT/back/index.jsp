	...
	<body style="height:100%;">
            ...
            <ul class="nav btn-group">
                ...
                <li class="btn btn-inverse dropdown" id="menu-messages">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="sAdd" title="" href="messagelist.html" target="iframe">未读留言</a></li>
                        <li><a class="sInbox" title="" href="#">空位1</a></li>
                        <li><a class="sOutbox" title="" href="#">空位2</a></li>
                        <li><a class="sTrash" title="" href="#">空位3</a></li>
                    </ul>
                </li>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="submenu">
					<a href="#"><i class="icon icon-pencil"></i> <span>用户管理</span><span class="label">1</span></a>
					<ul>
						<li><a href="findstu.html" target="iframe">学生管理</a></li>
					</ul>
				</li>
				<li class="submenu">
				...
				<li class="submenu">
					...
					<ul>
						<li><a href="postlist.html" target="iframe">留言列表</a></li>
					</ul>
				</li>
			</ul>
		...
		<!------------------------------------------------>
			<div class="main-content">
				...
				<iframe border="0" frameSpacing="0" frameBorder="no" cols="100%" style="width:100%;height:513px;" src="index02.html" name="iframe" >
